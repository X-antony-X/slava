...
const CategorySection = () => {
          ...
          const formattedCards = files
            ...
            .map((file, index) => {
              ...
              return {
                id: index,
                image_url: publicUrl,
                title: "Slava Collection", // تقدر تغيرها لبيانات من الـ Database لو حبيت
                category: "Spotlight" // تقدر تغيرها لبيانات من الـ Database لو حبيت
              };
            });
  ...
  return (
    <section className="bg-white text-black font-sans">
      ...
      {/* --- الجزء العلوي: Banners (ثابت زي ما هو) --- */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-0 overflow-hidden">
        {dbBanners.map((slide) => (
          <div key={slide.id} className="relative aspect-[4/5] md:aspect-auto md:h-[80vh] overflow-hidden group border-r border-gray-100 last:border-0">
            <img src={slide.image_url} alt={slide.title} className="w-full h-full object-cover transition-opacity duration-500 group-hover:opacity-90" />
      ...
      {/* --- الجزء السفلي: Spotlight (استنساخ الـ Offers) --- */}
      <div className="max-w-[1400px] mx-auto px-6 py-16">
        
        {/* Header مع الأسهم ورابط View All */}
        ...
        {/* Swiper Slider بنفس إعدادات الـ Offers */}
        <Swiper
